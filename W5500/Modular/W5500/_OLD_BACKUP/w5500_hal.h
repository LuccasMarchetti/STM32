...
#ifndef NETWORK_DRIVER_W5500_HAL_H_
#define NETWORK_DRIVER_W5500_HAL_H_
...
// W5500 Common register block select bits
...
// ---------------------------------------- Interrupt Registers End ----------------------------------------

// ---------------------------------------- Retry Registers Start ----------------------------------------

// Retry Time Register
#define W5500_COMMON_RTR 0x0019
#define W5500_COMMON_RTR_LEN 2
#define W5500_COMMON_RTR_us 100 // 100 microseconds
#define W5500_COMMON_RTR_DEFAULT 0x07D0 // 2000ms
...
// ---------------------------------------- PPPoe Registers Start ----------------------------------------

// PPP LCP Request Timer Register
#define W5500_COMMON_PTIMER 0x001C
#define W5500_COMMON_PTIMER_ms 25 // 25 milliseconds
#define W5500_COMMON_PTIMER_DEFAULT 0x0028 // 200ms
...
// PPP Destination MAC Address Register in PPPoE mode
#define W5500_COMMON_PSID 0x0024
#define W5500_COMMON_PSID_LEN 2

// Maximum Receive Unit Register in PPPoE mode
...
// ---------------------------------------- Unreach Registers End ----------------------------------------

// ---------------------------------------- Phy Registers Start ----------------------------------------

// PHY Configuration Register
#define W5500_COMMON_PHYCFGR 0x002E
#define W5500_COMMON_PHYCFGR_DEFAULT 0b10111000

// PHY Reset Bit (After PHY Reset, it should be set '1')
#define W5500_COMMON_PHYCFGR_RST ((uint8_t)(1u << 7))

// Configure PHY Operation Mode
#define W5500_COMMON_PHYCFGR_OPMD_HW_P 0x00
...
#define W5500_COMMON_PHYCFGR_ALL_CAPABLE_AUTO_NEGOTIATION_ENABLED (0b111u << 3)
...
// Multicasting in UDP mode and MAC Filter in MACRAW mode
#define W5500_Sn_MR_MULTI_MFEN ((uint8_t)(1u << 7))

// Broadcast Block in MACRAW and UDP mode
#define W5500_Sn_MR_BCASTB ((uint8_t)(1u << 6))

// Use no Delayed ACK in TCP mode or Multicasting in UDP mode using IGMP version 1 instead 2 or Multicasting in MACRAW mode
#define W5500_Sn_MR_ND_MC_MMB ((uint8_t)(1u << 5))

// Unicast Block in UDP mode or IPv6 Packet Block in MACRAW mode
...
#define W5500_Sn_MR_MACRAW_SOCKET 0
...
// TCP States
#define W5500_Sn_SR_SYN_SENT    0x15
#define W5500_Sn_SR_SYN_RECV    0x16
...
#define W5500_Sn_DHAR_DEFAULT 0xFFFFFFFFFFFF
...
// Socket n RX Interrupt Mask Register
...
// Socket n Fragmentation Offset Register
...
#define EVT_W5500_IRQ      (1 << 0)
#define EVT_SOCKET_TX      (1 << 1)
#define EVT_SOCKET_TIMEOUT 	(1 << 2)
#define EVT_SOCKET_RX      (1 << 3)
#define EVT_SOCKET_DISCON   (1 << 4)
#define EVT_SOCKET_CON     	(1 << 5)
#define EVT_DHCP_EVENT      (1 << 6)
#define EVT_APP_REQUEST     (1 << 7)
#define EVT_NET_TICK       	(1 << 8)
...
typedef enum {
    ...
    W5500_SOCK_FINWAIT     = 0x18,
    W5500_SOCK_CLOSING     = 0x1A,
    W5500_SOCK_TIMEWAIT   = 0x1B,
    W5500_SOCK_CLOSEWAIT  = 0x1C,
    W5500_SOCK_LASTACK    = 0x1D,
    W5500_SOCK_UDP         = 0x22,
...
#ifndef osStaticTimerDef_t
typedef StaticTimer_t osStaticTimerDef_t;
#endif

#ifndef osStaticMutexDef_t
typedef StaticSemaphore_t osStaticMutexDef_t;
#endif

#ifndef osStaticSemaphoreDef_t
...
typedef struct W5500_Driver_t {
    ...
    osSemaphoreId_t spiDoneSem;
    osStaticSemaphoreDef_t spiDoneSemControlBlock;
    osMutexId_t spiBusMutex;

    osStaticEventGroupDef_t EventControlBlock;
    osEventFlagsId_t EventHandle;

    osTimerId_t netTimerHandle;
    osStaticTimerDef_t netTimerControlBlock;
    ...
    W5500_SocketHW_t hw_sockets[W5500_MAX_SOCKETS];
    uint8_t used_sockets;
...
HAL_StatusTypeDef W5500_CloseSocket(W5500_Driver_t * drv, uint8_t socket_id);
HAL_StatusTypeDef W5500_SocketSend(W5500_Driver_t * drv, uint8_t socket_id, uint8_t * data, uint16_t len);
HAL_StatusTypeDef W5500_SocketRecv(W5500_Driver_t * drv, uint8_t socket_id, uint8_t * out, uint16_t max_len, uint16_t * out_len);
...
HAL_StatusTypeDef W5500_SetSocketDestIP(W5500_Driver_t * drv, uint8_t socket_id, uint8_t * ip);
HAL_StatusTypeDef W5500_SetSocketDestPort(W5500_Driver_t * drv, uint8_t socket_id, uint16_t port);
HAL_StatusTypeDef W5500_SetSocketDestMAC(W5500_Driver_t * drv, uint8_t socket_id, uint8_t * mac);
...
#endif /* NETWORK_DRIVER_W5500_HAL_H_ */
