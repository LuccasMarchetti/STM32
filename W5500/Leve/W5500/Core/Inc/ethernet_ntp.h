...
// Estrutura simples para guardar a data/hora final
typedef struct {
    uint16_t ano;
    uint8_t  mes;
    uint8_t  dia;
...
typedef struct {
    ...
    RTC_Time_t current_time; // Hora convertida para formato legível
} NTP_Control_t;
