...
C_DEPS += \
./Core/Network/Core/network_manager.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Network/Core/%.o Core/Network/Core/%.su Core/Network/Core/%.cyclo: ../Core/Network/Core/%.c Core/Network/Core/subdir.mk
...
clean: clean-Core-2f-Network-2f-Core

clean-Core-2f-Network-2f-Core:
	-$(RM) ./Core/Network/Core/network_manager.cyclo ./Core/Network/Core/network_manager.d ./Core/Network/Core/network_manager.o ./Core/Network/Core/network_manager.su

.PHONY: clean-Core-2f-Network-2f-Core
